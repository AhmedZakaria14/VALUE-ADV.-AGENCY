...
export const metadata: Metadata = {
  title: 'من نحن | وكالة فاليو للدعاية',
  description: 'تعرف على وكالة فاليو للدعاية والإعلان، فريق متخصص في تصميم وتصنيع وتركيب اللوحات الإعلانية بالرياض بخبرة واسعة.',
  alternates: {
    canonical: '/about',
  },
  openGraph: {
