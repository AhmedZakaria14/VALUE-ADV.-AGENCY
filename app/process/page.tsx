...
export const metadata: Metadata = {
  title: 'طريقة العمل | وكالة فاليو للدعاية',
  description: 'تعرف على خطوات عملنا في وكالة فاليو للدعاية والإعلان من الفكرة والتصميم إلى التنفيذ والتركيب لضمان أعلى جودة.',
  alternates: {
    canonical: '/process',
  },
  openGraph: {
